...
/**
 * Created by koushick on 05-Nov-17.
 */

public class MediaVideoFragment extends Fragment implements MediaPlayer.OnCompletionListener {
    ...
    MediaVideoFragment.MainHandler mediaHandler;
    SeekBar videoSeek;
    ...
    {
        mediaHandler = new MediaVideoFragment.MainHandler(this);
        startTracker = true;
        MediaVideoFragment.VideoTracker videoTracker = new MediaVideoFragment.VideoTracker();
        videoTracker.start();
    }
    ...
    class MainHandler extends Handler {
        WeakReference<MediaVideoFragment> mediaFragment;
        MediaVideoFragment mediaAct;

        public MainHandler(MediaVideoFragment mediaFragment1) {
